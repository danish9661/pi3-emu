...
const { createRng } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'rng.js'));
const { createTempSensor } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'temp.js'));
const { createClockMgr } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'clockmgr.js'));
const { createI2s } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'i2s.js'));
const { createSpi1 } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'spi1.js'));
const { createSpi2 } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'spi2.js'));
const { createI2c } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'i2c.js'));
const { createUart25 } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'uart25.js'));
const { createUsb } = await import(join(__dirname, '..', 'packages', 'pi3-emu', 'src', 'usb.js'));
