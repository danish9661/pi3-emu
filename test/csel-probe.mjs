...
//    movz x1,#0x61; movz x2,#0x61; movz x3,#0x20; subs xzr,x1,x2; subs w4,w1,w3; csel w5,w4,w1,ge
await run('lowercase->upper csel chain (a->A)', { 1: 0x61, 2: 0x61, 3: 0x20 }, [SUBS_R(31, 1, 2), SUBS_R(4, 1, 3), CSEL(5, 4, 1, 0xa), HALT], [[5, 0x41]]);
// 7. same with 'z' (0x7A) -> 0x5A
await run('lowercase->upper (z->Z)', { 1: 0x7a, 2: 0x61, 3: 0x20 }, [SUBS_R(31, 1, 2), SUBS_R(4, 1, 3), CSEL(5, 4, 1, 0xa), HALT], [[5, 0x5a]]);
// 8. same with '0' (0x30) -> NOT >= 'a' -> unchanged 0x30
await run('non-letter unchanged (0->0)', { 1: 0x30, 2: 0x61, 3: 0x20 }, [SUBS_R(31, 1, 2), SUBS_R(4, 1, 3), CSEL(5, 4, 1, 0xa), HALT], [[5, 0x30]]);
