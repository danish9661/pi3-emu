...
const CASES = [
  ...
  ['rpi-kernel', 'rpi-kernel', ['20000000', '4096', '262144', '0', '0', '0', '72', '16000000'], {},
    { console: ['rpi-kernel M54', 'in EL1 (CurrentEL 0x4)', 'timer freq 19200000', 'drivers loaded:', 'before svc', 'SVC EC 0x15 ISS 0x1337', 'after svc', 'mmu: off', 'mmu: on', '[timer 1]', '[timer 2]', '[timer 3]', 'timer done', 'Echoing input now', "[echo 'H']"], fault: 'null' }],
