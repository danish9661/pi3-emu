import './styles.css';
import { parseElf, loadElf } from '../packages/pi3-emu/src/elf.js';
import { mmuEnable, mmuMirrorWrite } from '../packages/pi3-emu/src/mmu.js';
import { dmaRunChain } from '../packages/pi3-emu/src/dma.js';
import { createPwm } from '../packages/pi3-emu/src/pwm.js';
import { createI2c } from '../packages/pi3-emu/src/i2c.js';
import { createSpi } from '../packages/pi3-emu/src/spi.js';
import { createUart1 } from '../packages/pi3-emu/src/uart1.js';
import { createUart0 } from '../packages/pi3-emu/src/uart0.js';
import { createSdhci } from '../packages/pi3-emu/src/sdhci.js';
import { createLocalInt } from '../packages/pi3-emu/src/localint.js';
import { createIc } from '../packages/pi3-emu/src/ic.js';
import { createGpio } from '../packages/pi3-emu/src/gpio.js';
import { createRng } from '../packages/pi3-emu/src/rng.js';
import { createTempSensor } from '../packages/pi3-emu/src/temp.js';
import { createClockMgr } from '../packages/pi3-emu/src/clockmgr.js';
import { createI2s } from '../packages/pi3-emu/src/i2s.js';
import { createSpi1 } from '../packages/pi3-emu/src/spi1.js';
